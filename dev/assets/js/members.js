...
$(document).ready(function() {
  ...
  if (localStorage.member) {
    if(localStorage.member < 23){
      var mm = parseInt(localStorage.getItem("member"));
      var mnm = mm+1;
      localStorage.setItem("member", mnm);
    }
    if(localStorage.member >= 23){
  ...
  var info = ['Académica, investigadora e historiadora del arte. Tuvo varias contribuciones en los estudios de arqueología de Mesoamérica. Beatriz Ramírez de la Fuente logró acercarse al arte mesoamericano, de una manera sobresaliente. No solo entendió la generalidad de sus estilos, supo identificar talleres de escultura a través de sus rasgos estilísticos e incluso artistas específicos por sus nombres, como Och o Pequeña Zarigüeya, el maestro pintor de Bonampak', 
    ...
    'Teodoro González de León diseñó algunos de los edificios más emblemáticos de la Ciudad de México. Como El Colegio de México, el Museo Universitario Arte Contemporáneo o el Edificio Virreyes. Fernando Romero fue el encargado de diseñar el Museo Soumaya.', 
    ...
    'En 1976, Linda participó en las excavaciones realizadas por la Universidad de Roma "La Sapienza" en Arslatepé, Turquía, donde descubrió la sala de armas de uno de los palacios más antiguos del Medio Oriente. Fue por estas excavaciones que comenzó a tener renombre internacional.']; 
  ...
  var options8 = ['Manuel Gamio y Manuel Gutierrez Nájera', 'José Vasconcelos y Nezahualcóyotl', 'Sor Juana Inés de la Cruz y  Cuitláhuac'];
  ...
  var options16 = ['La creación del Centro de Estudios Lingüísticos Literarios', 'La creación del Centro de Estudios Económicos y Demográficos', 'La fundación del Centro de Estudios Históricos'];
  ...
  var mmm = parseInt(localStorage.getItem("member"));
